...
const OtherCostModalDialog = (props: IOtherCostModalDialog) => {
  ...
  const [isOtherCostAddition, setIsOtherCostAddition] = useState<boolean>(
    props.isAddition
  );
  ...
  const validateOtherCost = () => {
    ...
    if (glAccount === '') {
      ...
      setPageHasError(true);
    } else setGlAccountError(false);

    if (profitCentre === '') {
      setProfitCenterError(true);
      setPageHasError(true);
    } else setProfitCenterError(false);

    if (costCenter === '') {
      setCostCenterError(true);
      setPageHasError(true);
    } else setCostCenterError(false);

    if (internalOrder === '') {
      setInternalOrderError(true);
      setPageHasError(true);
    } else setInternalOrderError(false);

    if (fund === '') {
      setFundError(true);
      setPageHasError(true);
    } else setFundError(false);

    if (remarks === '') {
      setRemarksError(true);
      setPageHasError(true);
    } else setRemarksError(false);
  };
