            ...
            <GoATable onSort={sortData}>
              <thead>
                ...
                <th style={{ maxWidth:'2%', padding:'12px 0 12px 32px'}}>
                    <input type='checkbox' name='allApproved' style={{ width: '20px', height:'20px', verticalAlign: 'bottom' }}></input>
                  </th>
                  ...
                  <th style={{ maxWidth: '12%', textAlign: 'right'}}>                  
                  </th>
                </tr>
              </thead>
                ...
                {paginationResults?.data && paginationResults.data.length > 0 ? (
                  paginationResults.data.map((record: any, index: any) => (
                    ...
                    <tr key={record.flightReportId}>
                      ...
                      <input type='checkbox' name={record.flightReportId} style={{ width: '20px', height:'20px', verticalAlign: 'bottom' }}></input>
                      </td>
                      <td>
                        {moment(record.flightReportDate).format('DD/MM/YYYY')}
                      </td>
                      <td>
                        <GoAButton {...{ style: '"padding: 0 10px 0 10px;height: 90px;"' }}
                          size='compact' type='tertiary' onClick={() => flightReportClick(record?.flightReportId) }>
